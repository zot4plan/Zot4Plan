 ...
 * License: MIT
*/
function MusicNote ({className = '', fontSize = '1rem'}: IconProps) {
    return (
        <svg className={className} 
            style={{fontSize: fontSize}}
            xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 16 16">
