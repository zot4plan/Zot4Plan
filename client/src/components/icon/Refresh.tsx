/**  
 * Source:https://icon-sets.iconify.design/iconoir/refresh-circular/
 * Author: Luca Burgio
 * License: MIT
*/
function Refresh () {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" width="5em" height="5em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24">
